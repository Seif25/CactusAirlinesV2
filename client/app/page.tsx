...
export default function Home() {
  ...
  return (
    <div className="p-16 pb-40">
      {/* Hero */}
      <div className="grid grid-cols-2 gap-10 h-auto pb-40">
        <div className="flex flex-col justify-center h-auto">
          ...
          <div className="relative -z-10 top-[75px]">
            <Image
              src={"/gradient.jpg"}
              alt="plane"
              width={500}
      ...
      <div id="browse" className="bg-[#FFEACE] shadow-sm shadow-[#534439] w-full h-auto rounded-md p-5">
        ...
        <div className="bg-[#534439] bg-opacity-10 rounded-md w-auto h-[70px] flex items-center justify-evenly gap-5 px-2">
